<html>
	<head>
		...
		<title>Rank the Things FAQ</title>
	</head>
	<body>
		<div id="wrapper">
			<h2>Frequently Asked Questions</h2>
			<h4>What is this?</h4>
			<p>Have you ever debated with your friends over what the best pizza topping or the greatest Pixar movie is? This is here to provide a totally definitive ranking to solve these debates once and for all, using the power of crowdsourcing!</p>
			...
			<p>Great! I'm all ears! <a href="mailto:contact@hdwhite.org" style="font-size:100%">Let me know</a> and I will certainly keep it in mind for a future week.</p>
		</div>
	</body>
</html>
